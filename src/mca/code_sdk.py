...
def render_python_sdk(registry: ToolRegistry) -> str:
    ...
    lines = [
        ...
        "Triple-quoted multiline strings preserve exact content. Supported",
        "control/data syntax includes assignments, if/for/while, try/except,",
        "list/dict comprehensions, await, explicit return, and gather(*nodes).",
        "Function/class definitions, imports, lambda, reflection, **kwargs, and",
        "starred literals are unavailable.",
        ...
        "A failed run_code may already have succeeded tool nodes. Always inspect",
        "execution_summary and the DAG, then retry only failed or skipped work;",
        "do not blindly repeat successful writes or shell commands.",
        "",
